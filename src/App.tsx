    ...
    <div className="app">
      ...
      <main className="content">
        {activePage === "dashboard" ? (
          <DashboardPage
            rows={dashboardRows}
            totalKwh={dashboardCalculations.totalKwh}
            energyCharge={dashboardCalculations.energyCharge}
            ftCharge={dashboardCalculations.ftCharge}
            serviceCharge={dashboardCalculations.serviceCharge}
            vat={dashboardCalculations.vat}
            totalBill={dashboardCalculations.totalBill}
            vatRate={vatRate}
          />
        ) : (
          <>
